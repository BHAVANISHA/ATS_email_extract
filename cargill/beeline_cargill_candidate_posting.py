...
class cargill_update:
    ...
    def cargill_extract_information(self):
        ...
        for entry in unread_emails:
            ...
            for line in lines:
                ...
                elif '**Candidate Name:**'in line:
                    Candidate_Name = line.split( '**Candidate Name:**' )[1].strip( ":**" )
                    comments.append( "Candidate Name:" + Candidate_Name )
...
results = cargill_update()
results.cargill_extract_information()
