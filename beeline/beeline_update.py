...
class beeline_client1_update:
    ...
    def beeline1_extract_information(self):
        ...
        for entry in unread_emails:
            ...
            for line in lines:
                ...
                if 'Request Number:' in line:
                    ...
                    # Now you have the location information for this email
                    if location:
...
results = beeline_client1_update()
results.beeline1_extract_information()
